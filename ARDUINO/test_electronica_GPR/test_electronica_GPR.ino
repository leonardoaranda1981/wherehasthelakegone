/**************************************************************************************
   ...
   Interfacing Arduino board with ST7789 TFT display (240x240 pixel).
...
void setup(void) {
  ...
  attachInterrupt(digitalPinToInterrupt(HallSensor), readHallSensor, FALLING);
...
void loop() {
  estadoBotonOk = digitalRead(button_OK);
  estadoBotonDown = digitalRead(button_down);
  estadoBotonUp = digitalRead(button_up);

  if (estadoBotonOk == HIGH) {
    Serial.println("Boton OK apretado");
  }
  if (estadoBotonDown == HIGH) {
    Serial.println("Boton DOWN apretado");
  }
  if (estadoBotonUp == HIGH) {
...
void readHallSensor() {
  ...
  if (sensorStatus == 1) // Check if the pin high or not
  {
    ...
    //if (sensorStatusBool) {
      Serial.println("iman retirado");
      sensorStatusBool = false;
   // }

  }
  else  {
   // if (!sensorStatusBool) {
      Serial.println("iman encontrado");
      sensorStatusBool = true;
